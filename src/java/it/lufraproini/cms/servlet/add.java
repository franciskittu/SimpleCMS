...
public class add extends HttpServlet {
    ...
    private void aggiungi_pagina(CMSDataLayerImpl datalayer, Map info, Utente U) throws ErroreGrave{
        List<Sito> sito = datalayer.getSitobyUtente(U);
        long id_padre;
        try{
             id_padre = SecurityLayer.checkNumeric(info.get("id_padre").toString());
        ...
        p.setBody(SecurityLayer.addSlashes(info.get("editor").toString()));
        p.setTitolo(SecurityLayer.addSlashes(info.get("title").toString()));
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (s != null) {
            try {
                ...
                if(parametri.containsKey("title") && parametri.containsKey("id_padre") && parametri.containsKey("editor")){
                    aggiungi_pagina(datalayer, parametri, U);
